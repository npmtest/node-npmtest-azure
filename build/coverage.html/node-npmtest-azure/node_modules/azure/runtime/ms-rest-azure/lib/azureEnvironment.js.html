...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure/runtime/ms-rest-azure/lib/azureEnvironment.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure/runtime/ms-rest-azure/lib/azureEnvironment.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.12% <small>(16 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">94.12% <small>(16 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure/runtime/ms-rest-azure/lib/</a> &#187; azureEnvironment.js</div>
</div>
<div class="body">
...
&nbsp;
  if (parameters) {
    ...
    requiredParams.forEach(function (param) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!parameters[param] || typeof parameters[param].valueOf() !== 'string') {
<span class="cstat-no" title="statement not covered" >        throw new Error(`Please provide "${param}" for the environment and it must be of type "string".`);</span>
      }
    });
