...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-asm-scheduler/lib/scheduler.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-asm-scheduler/lib/scheduler.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-asm-scheduler/lib/</a> &#187; scheduler.js</div>
</div>
<div class="body">
...
*/
exports.createSchedulerManagementClient = <span class="fstat-no" title="function not covered" >function (credentials, baseUri, filters) {</span>
<span class="cstat-no" title="statement not covered" >  return new exports.SchedulerManagementClient.SchedulerManagementClient(credentials, baseUri, filters);</span>
};
&nbsp;
...
*/
exports.createCloudServiceManagementClient = <span class="fstat-no" title="function not covered" >function (credentials, baseUri) {</span>
<span class="cstat-no" title="statement not covered" >  return new exports.CloudServiceManagementClient.CloudServiceManagementClient(credentials, baseUri);</span>
};
&nbsp;
