...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-common/lib/common.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-common/lib/common.js</span></h1>
    <h2>
        
        Statements: <span class="metric">82.76% <small>(48 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-common/lib/</a> &#187; common.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (nodeVersion.major === 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >nodeVersion.minor &gt; 8 </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!(nodeVersion.minor &gt; 10 || (nodeVersion.minor === 10 &amp;&amp; nodeVersion.patch &gt;= 3)))</span> {
<span class="cstat-no" title="statement not covered" >  throw new Error('The Microsoft Azure node SDK does not work with node versions &gt; 0.8.22 and &lt; 0.10.3. Please upgrade to node &gt;= 0.10.3');</span>
}
&nbsp;
...
&nbsp;
exports.configure = <span class="fstat-no" title="function not covered" >function (env, configCallback) {</span>
<span class="cstat-no" title="statement not covered" >  if (arguments.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >    exports.config.configure(env);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    exports.config.configure(env, configCallback);</span>
  }
};
&nbsp;
exports.dumpConfig = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  console.log();</span>
<span class="cstat-no" title="statement not covered" >  exports.config.environments.forEach(<span class="fstat-no" title="function not covered" >function (e) {</span></span>
<span class="cstat-no" title="statement not covered" >    console.log('Environment', e);</span>
<span class="cstat-no" title="statement not covered" >    var env = exports.config(e);</span>
<span class="cstat-no" title="statement not covered" >    env.settings.forEach(<span class="fstat-no" title="function not covered" >function (setting) {</span></span>
<span class="cstat-no" title="statement not covered" >      console.log('    ', setting, ':', env.get(setting));</span>
    });
  });
};
&nbsp;
