...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-sb/lib/servicebus.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-sb/lib/servicebus.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-sb/lib/</a> &#187; servicebus.js</div>
</div>
<div class="body">
...
*/
exports.createServiceBusService = <span class="fstat-no" title="function not covered" >function (configOrNamespaceOrConnectionString, accessKey, issuer, acsNamespace, host, authenticationProvider) {</span>
<span class="cstat-no" title="statement not covered" >  return new ServiceBusService(configOrNamespaceOrConnectionString, accessKey, issuer, acsNamespace, host, authenticationProvider);</span>
};
&nbsp;
/**
...
*/
exports.createNotificationHubService = <span class="fstat-no" title="function not covered" >function (hubName, endpointOrConnectionString, sharedAccessKeyName, sharedAccessKeyValue) {</span>
<span class="cstat-no" title="statement not covered" >  return new NotificationHubService(hubName, endpointOrConnectionString, sharedAccessKeyName, sharedAccessKeyValue);</span>
};
&nbsp;
/**
...
*/
exports.createWrapService = <span class="fstat-no" title="function not covered" >function (acsHost, issuer, accessKey) {</span>
<span class="cstat-no" title="statement not covered" >	return new WrapService(acsHost, issuer, accessKey);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
