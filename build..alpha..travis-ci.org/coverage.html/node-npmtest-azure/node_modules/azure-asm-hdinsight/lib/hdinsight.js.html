...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-asm-hdinsight/lib/hdinsight.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-asm-hdinsight/lib/hdinsight.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">76.47% <small>(13 / 17)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-asm-hdinsight/lib/</a> &#187; hdinsight.js</div>
</div>
<div class="body">
...
*/
exports.createHDInsightJobManagementClient = <span class="fstat-no" title="function not covered" >function (clusterName, credentials) {</span>
<span class="cstat-no" title="statement not covered" >	return new exports.HDInsightJobManagementClient.HDInsightJobManagementClient(clusterName, credentials);</span>
};
&nbsp;
...
* @param {string} [credentials.key]                 The key value.
*/
exports.createHDInsightClusterManagementClient = <span class="fstat-no" title="function not covered" >function (cloudServiceName, credentials) {</span>
<span class="cstat-no" title="statement not covered" >	return new exports.HDInsightClusterManagementClient.HDInsightClusterManagementClient(cloudServiceName, credentials);</span>
};
&nbsp;
...
* @param {string} [credentials.key]                 The key value.
*/
exports.createHDInsightCluster2ManagementClient = <span class="fstat-no" title="function not covered" >function (cloudServiceName, credentials) {</span>
<span class="cstat-no" title="statement not covered" >	return new exports.HDInsightCluster2ManagementClient.HDInsightCluster2ManagementClient(cloudServiceName, credentials);</span>
};
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	return new exports.BasicAuthenticationCloudCredentials.BasicAuthenticationCloudCredentials(credentials);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
