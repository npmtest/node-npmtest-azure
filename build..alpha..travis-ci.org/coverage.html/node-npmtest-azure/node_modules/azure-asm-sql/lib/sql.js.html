...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-asm-sql/lib/sql.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-asm-sql/lib/sql.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-asm-sql/lib/</a> &#187; sql.js</div>
</div>
<div class="body">
...
*/
exports.createSqlManagementService = <span class="fstat-no" title="function not covered" >function (subscriptionId, authentication, hostOptions) {</span>
<span class="cstat-no" title="statement not covered" >  return new SqlManagementService(subscriptionId, authentication, hostOptions);</span>
};
&nbsp;
/**
...
*/
exports.createSqlManagementClient = <span class="fstat-no" title="function not covered" >function (credentials, baseUri, filters) {</span>
<span class="cstat-no" title="statement not covered" >  return new exports.SqlManagementClient.SqlManagementClient(credentials, baseUri, filters);</span>
};
&nbsp;
...
*/
exports.createSqlService = <span class="fstat-no" title="function not covered" >function (serverName, administratorLogin, administratorLoginPassword, host, acsHost, authenticationProvider) {</span>
<span class="cstat-no" title="statement not covered" >	return new SqlService(serverName, administratorLogin, administratorLoginPassword, host, acsHost, authenticationProvider);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
