...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-asm-website/lib/website.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-asm-website/lib/website.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">73.91% <small>(17 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-asm-website/lib/</a> &#187; website.js</div>
</div>
<div class="body">
...
*/
exports.createWebSiteManagementClient = <span class="fstat-no" title="function not covered" >function (credentials, baseUri, filters) {</span>
<span class="cstat-no" title="statement not covered" >  return new exports.WebSiteManagementClient.WebSiteManagementClient(credentials, baseUri, filters);</span>
};
&nbsp;
...
* @return {WebSiteManagementClient}                 A new WebSiteManagementClient object.
*/
exports.createWebSiteExtensionsClient = <span class="fstat-no" title="function not covered" >function (siteName, credentials, baseUri, filters) {</span>
<span class="cstat-no" title="statement not covered" >  return new exports.WebSiteExtensionsClient.WebSiteExtensionsClient(siteName, credentials, baseUri, filters);</span>
};
&nbsp;
/**
...
*/
exports.createWebsiteManagementService = <span class="fstat-no" title="function not covered" >function (subscriptionId, authentication, hostOptions) {</span>
<span class="cstat-no" title="statement not covered" >  return new WebsiteManagementService(subscriptionId, authentication, hostOptions);</span>
};
&nbsp;
/**
...
*/
exports.createScmService = <span class="fstat-no" title="function not covered" >function (authentication, hostOptions) {</span>
<span class="cstat-no" title="statement not covered" >  return new ScmService(authentication, hostOptions);</span>
};
&nbsp;
...
*/
exports.createCertificateCloudCredentials = <span class="fstat-no" title="function not covered" >function (credentials) {</span>
<span class="cstat-no" title="statement not covered" >  return new common.CertificateCloudCredentials(credentials);</span>
};
&nbsp;
...
*/
exports.createBasicAuthenticationCloudCredentials = <span class="fstat-no" title="function not covered" >function (credentials) {</span>
<span class="cstat-no" title="statement not covered" >  return new BasicAuthenticationCloudCredentials(credentials);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
