...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-storage/lib/azure-storage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-storage/lib/azure-storage.js</span></h1>
    <h2>
        
        Statements: <span class="metric">72.41% <small>(42 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">72.41% <small>(42 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-storage/lib/</a> &#187; azure-storage.js</div>
</div>
<div class="body">
...
*/
exports.generateDevelopmentStorageCredentials = <span class="fstat-no" title="function not covered" >function (proxyUri) {</span>
<span class="cstat-no" title="statement not covered" >  var devStore = 'UseDevelopmentStorage=true;';</span>
<span class="cstat-no" title="statement not covered" >  if(proxyUri){</span>
<span class="cstat-no" title="statement not covered" >    devStore += 'DevelopmentStorageProxyUri=' + proxyUri;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return devStore;</span>
};
&nbsp;
/**
...
*
*/
exports.createTableService = <span class="fstat-no" title="function not covered" >function (storageAccountOrConnectionString, storageAccessKey, host) {</span>
<span class="cstat-no" title="statement not covered" >  return new TableService(storageAccountOrConnectionString, storageAccessKey, host);</span>
};
&nbsp;
/**
...
*/
exports.createTableServiceWithSas = <span class="fstat-no" title="function not covered" >function (hostUri, sasToken) {</span>
<span class="cstat-no" title="statement not covered" >  return new TableService(null, null, hostUri, sasToken);</span>
};
&nbsp;
/**
 * Blob client exports.
...
*/
exports.createBlobService = <span class="fstat-no" title="function not covered" >function (storageAccountOrConnectionString, storageAccessKey, host) {</span>
<span class="cstat-no" title="statement not covered" >  return new BlobService(storageAccountOrConnectionString, storageAccessKey, host, null);</span>
};
&nbsp;
/**
...
*/
exports.createBlobServiceWithSas = <span class="fstat-no" title="function not covered" >function (host, sasToken) {</span>
<span class="cstat-no" title="statement not covered" >  return new BlobService(null, null, host, sasToken);</span>
};
&nbsp;
/**
...
*/
exports.createBlobServiceAnonymous = <span class="fstat-no" title="function not covered" >function (host) {</span>
<span class="cstat-no" title="statement not covered" >  return new BlobService(null, null, host, null);</span>
};
&nbsp;
/**
 * File client exports.
...
*/
exports.createFileService = <span class="fstat-no" title="function not covered" >function (storageAccountOrConnectionString, storageAccessKey, host) {</span>
<span class="cstat-no" title="statement not covered" >  return new FileService(storageAccountOrConnectionString, storageAccessKey, host);</span>
};
&nbsp;
/**
...
*/
exports.createFileServiceWithSas = <span class="fstat-no" title="function not covered" >function (hostUri, sasToken) {</span>
<span class="cstat-no" title="statement not covered" >  return new FileService(null, null, hostUri, sasToken);</span>
};
&nbsp;
/**
...
*/
exports.createQueueService = <span class="fstat-no" title="function not covered" >function (storageAccountOrConnectionString, storageAccessKey, host) {</span>
<span class="cstat-no" title="statement not covered" >  return new QueueService(storageAccountOrConnectionString, storageAccessKey, host);</span>
};
&nbsp;
/**
...
*/
exports.createQueueServiceWithSas = <span class="fstat-no" title="function not covered" >function(hostUri, sasToken) {</span>
<span class="cstat-no" title="statement not covered" >  return new QueueService(null, null, hostUri, sasToken);</span>
};
&nbsp;
/**
* Account SAS
...
*/
exports.generateAccountSharedAccessSignature = <span class="fstat-no" title="function not covered" >function(storageAccountOrConnectionString, storageAccessKey, sharedAccessAccountPolicy)</span>
{
<span class="cstat-no" title="statement not covered" >  var storageSettings = StorageServiceClient.getStorageSettings(storageAccountOrConnectionString, storageAccessKey);</span>
<span class="cstat-no" title="statement not covered" >  var sharedKey = new SharedKey(storageSettings._name, storageSettings._key);</span>
  
<span class="cstat-no" title="statement not covered" >  return sharedKey.generateAccountSignedQueryString(sharedAccessAccountPolicy);</span>
};
&nbsp;
&nbsp;
/**
