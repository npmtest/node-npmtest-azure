...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-storage/lib/common/streams/readablefs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-storage/lib/common/streams/readablefs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-storage/lib/common/streams/</a> &#187; readablefs.js</div>
</div>
<div class="body">
...
*/
&nbsp;
exports.createReadStream = <span class="fstat-no" title="function not covered" >function(path, options) {</span>
<span class="cstat-no" title="statement not covered" >  var stream = fs.createReadStream(path, options);</span>
<span class="cstat-no" title="statement not covered" >  if (/^v0\.8\./.test(process.version)) {</span>
<span class="cstat-no" title="statement not covered" >    stream = rs().wrap(stream);</span>
  }
