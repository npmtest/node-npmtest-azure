...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-storage/lib/common/util/accesscondition.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-storage/lib/common/util/accesscondition.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-storage/lib/common/util/</a> &#187; accesscondition.js</div>
</div>
<div class="body">
...
*/
exports.generateEmptyCondition = <span class="fstat-no" title="function not covered" >function () {</span>
...
*/
exports.generateIfNotExistsCondition = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.EtagNonMatch = '*';</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
*/
exports.generateIfExistsCondition = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.EtagMatch = '*';</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
*/
exports.generateIfNoneMatchCondition = <span class="fstat-no" title="function not covered" >function (etag) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.EtagNonMatch = etag;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
*/
exports.generateIfMatchCondition = <span class="fstat-no" title="function not covered" >function (etag) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.EtagMatch = etag;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
*/
exports.generateIfModifiedSinceCondition = <span class="fstat-no" title="function not covered" >function (time) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.DateModifedSince = time;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
*/
exports.generateIfNotModifiedSinceCondition = <span class="fstat-no" title="function not covered" >function (time) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.DateUnModifiedSince = time;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
* @return {AccessConditions}                   An AccessCondition object that represents the If-Unmodified-Since condition
*/
exports.generateSequenceNumberEqualCondition = <span class="fstat-no" title="function not covered" >function (sequenceNumber) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.SequenceNumberEqual = sequenceNumber;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
* @return {AccessConditions}                   An AccessCondition object that represents the If-Unmodified-Since condition
*/
exports.generateSequenceNumberLessThanCondition = <span class="fstat-no" title="function not covered" >function (sequenceNumber) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.SequenceNumberLessThan = sequenceNumber;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;
/**
...
* @return {AccessConditions}                   An AccessCondition object that represents the If-Unmodified-Since condition
*/
exports.generateSequenceNumberLessThanOrEqualCondition = <span class="fstat-no" title="function not covered" >function (sequenceNumber) {</span>
<span class="cstat-no" title="statement not covered" >  var accessCondition = {};</span>
<span class="cstat-no" title="statement not covered" >  accessCondition.SequenceNumberLessThanOrEqual = sequenceNumber;</span>
<span class="cstat-no" title="statement not covered" >  return accessCondition;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
