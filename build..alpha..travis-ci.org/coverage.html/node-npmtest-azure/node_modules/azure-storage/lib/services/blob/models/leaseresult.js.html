...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-storage/lib/services/blob/models/leaseresult.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-storage/lib/services/blob/models/leaseresult.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-storage/lib/services/blob/models/</a> &#187; leaseresult.js</div>
</div>
<div class="body">
...
*/
<span class="fstat-no" title="function not covered" >function LeaseResult(container, blob, id, time) {</span>
...
&nbsp;
LeaseResult.prototype.getPropertiesFromHeaders = <span class="fstat-no" title="function not covered" >function (headers) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!self['id'] &amp;&amp; headers[HeaderConstants.LEASE_ID]) {</span>
<span class="cstat-no" title="statement not covered" >    self['id'] = headers[HeaderConstants.LEASE_ID];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!self['time'] &amp;&amp; headers[HeaderConstants.LEASE_TIME]) {</span>
<span class="cstat-no" title="statement not covered" >    self['time'] = parseInt(headers[HeaderConstants.LEASE_TIME], 10);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  self['etag'] = headers[HeaderConstants.ETAG];</span>
<span class="cstat-no" title="statement not covered" >  self['lastModified'] = headers[HeaderConstants.LAST_MODIFIED.toLowerCase()];</span>
};
&nbsp;
