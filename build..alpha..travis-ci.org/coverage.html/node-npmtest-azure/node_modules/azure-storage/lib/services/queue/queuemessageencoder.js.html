...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure/node_modules/azure-storage/lib/services/queue/queuemessageencoder.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure/node_modules/azure-storage/lib/services/queue/queuemessageencoder.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure/node_modules/azure-storage/lib/services/queue/</a> &#187; queuemessageencoder.js</div>
</div>
<div class="body">
 ...
 * @class
 */
<span class="fstat-no" title="function not covered" >function QueueMessageEncoder() {</span>
}
&nbsp;
/**
 ...
 * @return  {string}
 */
QueueMessageEncoder.prototype.encode = <span class="fstat-no" title="function not covered" >function(input){</span>
 ...
 * @returns {any}
 */
QueueMessageEncoder.prototype.decode = <span class="fstat-no" title="function not covered" >function(textToBeDecoded){</span>
<span class="cstat-no" title="statement not covered" >  return textToBeDecoded;</span>
};
&nbsp;
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function TextBase64QueueMessageEncoder(){</span>
}
 ...
 * @return {string}
 */
TextBase64QueueMessageEncoder.prototype.encode = <span class="fstat-no" title="function not covered" >function(input){</span>
<span class="cstat-no" title="statement not covered" >  return new Buffer(input, 'utf8').toString('base64');</span>
};
&nbsp;
/**
 * Decode from base64 string to utf-8 string.
 ...
 * @return {string}
 */
TextBase64QueueMessageEncoder.prototype.decode = <span class="fstat-no" title="function not covered" >function(textToDecode){</span>
<span class="cstat-no" title="statement not covered" >  return new Buffer(textToDecode, 'base64').toString('utf8');</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @extends {QueueMessageEncoder}
 */
<span class="fstat-no" title="function not covered" >function BinaryBase64QueueMessageEncoder(){</span>
}
 ...
 * @return {string}
 */
BinaryBase64QueueMessageEncoder.prototype.encode = <span class="fstat-no" title="function not covered" >function(input){</span>
<span class="cstat-no" title="statement not covered" >  return input.toString('base64');</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @return {Buffer}
 */
BinaryBase64QueueMessageEncoder.prototype.decode = <span class="fstat-no" title="function not covered" >function(textToDecode){</span>
<span class="cstat-no" title="statement not covered" >  return new Buffer(textToDecode, 'base64');</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @extends {QueueMessageEncoder}
 */
<span class="fstat-no" title="function not covered" >function TextXmlQueueMessageEncoder(){</span>
}
 ...
 * @return {string}
 */
TextXmlQueueMessageEncoder.prototype.encode = <span class="fstat-no" title="function not covered" >function(input){</span>
<span class="cstat-no" title="statement not covered" >  return input.replace(/&amp;/gm, '&amp;amp;')</span>
    .replace(/&lt;/gm, '&amp;lt;')
    .replace(/&gt;/gm, '&amp;gt;')
    .replace(/"/gm, '&amp;quot;')
    .replace(/'/gm, '&amp;apos;');
 ...
 * @return {string}
 */
TextXmlQueueMessageEncoder.prototype.decode = <span class="fstat-no" title="function not covered" >function(textToDecode){</span>
<span class="cstat-no" title="statement not covered" >  return textToDecode.replace(/&amp;amp;/gm, '&amp;')</span>
    .replace(/&amp;lt;/gm, '&lt;')
    .replace(/&amp;gt;/gm, '&gt;')
    .replace(/&amp;quot;/gm, '"')
    .replace(/&amp;apos;/gm, '\'');
